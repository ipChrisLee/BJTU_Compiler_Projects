...
this_demo_path=demo/demo_ppg_hw

lialex_file=${this_demo_path}/hw.lialex
#lialex_file=${this_demo_path}/LL_with_literal.lialex
liappg_file=${this_demo_path}/hw.liagra
#liappg_file=${this_demo_path}/LL_with_literal.liagra
target_lexer_info_hpp=${this_demo_path}/src/hw_lexer_info.hpp
target_parser_info_hpp=${this_demo_path}/src/hw_parser_info.hpp
lexer_info_name=hw_lexer_info
parser_info_name=hw_parser_info

this_demo_exe=${cmake_folder}/demo/demo_ppg_hw/demo_ppg_hw
...
# make demo
cd ${cmake_folder} && make demo_ppg_hw && cd ..
