...
this_demo_path=demo/demo_spg_hw

lialex_file=${this_demo_path}/SLR.lialex
#lialex_file=${this_demo_path}/LL_with_literal.lialex
liaspg_file=${this_demo_path}/SLR.liagra
...
this_demo_exe=${cmake_folder}/demo/demo_spg_hw/demo_spg_hw
...
# make demo
cd ${cmake_folder} && make demo_spg_hw && cd ..
